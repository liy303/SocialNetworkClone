...
<head>
    ...
    <title>Welcomet to Pawfect Friends!</title>
    <link href="https://fonts.googleapis.com/css?family=Freckle+Face|Luckiest+Guy|Suranna" rel="stylesheet">
        ...
        <div class='login_box'>
            ...
            <div id='second'>
                ...
                <form action="register.php" method='POST'>
                    ...
                    <input type="email" name='reg_email2' placeholder='Confrim Email' value="<?php 
